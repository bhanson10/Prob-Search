...
for i=1:sim.timesteps
    ...
    sgtitle(['Nonstationary searching, iter = ',num2str(i), ', t = ', num2str(t), ', \Delta t = ', num2str(sim.dt), ', \lambda = ', num2str(target.lambda), ', \psi = ', num2str(target.psi), ', a = ', num2str(drones.a*sim.dt), '/\Delta','t, \sigma = ', num2str(drones.sigma),', d = ', num2str(drones.d)]);
...
create_video(frames, sim, ['./Figures/Nonstationary/nonstationary_search_',title_str,'.mp4']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
