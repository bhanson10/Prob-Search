...
for i=1:sim.timesteps
    ...
    sgtitle(['Stationary searching, iter = ',num2str(i), ', t = ', num2str(t), ', \Delta t = ', num2str(sim.dt), ', \lambda = ', num2str(target.lambda), ', a = ', num2str(drones.a*sim.dt), '/\Delta','t', ', \sigma = ', num2str(drones.sigma)]);
...
%sgtitle([]); 
%tightfig;
%saveas(gcf,['./Figures/Stationary/stationary_search_',num2str(target.lambda),'_midframe_tight.eps'],'epsc');
...
create_video(frames, sim, ['./Figures/Stationary/stationary_search_',num2str(target.lambda),'.mp4']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
